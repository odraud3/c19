...
var oppPink1Img,oppPink2Img,oppPink3Img;
...
function preload(){
  ...
  mainRacerImg2= loadAnimation("mainPlayer2.png");
  mainRacerImg3= loadAnimation("mainPlayer3.png");
  
  oppPink1Img = loadAnimation("opponent1.png");
  oppPink2Img = loadAnimation("opponent2.png");
  oppPink3Img = loadAnimation("opponent3.png");
...
function draw() {
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    fill("red");
    textSize(20);
    text("pressione seta para cima para reiniciar",500,200);
